...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get onboardingTitle => 'FT-music에 오신 것을 환영합니다';
  ...
  @override
  String get updateNewVersionAvailable => '새로운 버전의 FT-music🌸가 출시되었습니다!';
  ...
  @override
  String get aboutTipQuote => 'FT-music가 마음에 드시나요? 소중한 후원이 더 멋진 발전을 만듭니다. 🌸';
  ...
  @override
  String get importBloomeeFiles => 'FT-music 파일 가져오기';
  ...
  String get importNoteMessage =>
      'FT-music에서 생성한 파일만 정상적으로 가져올 수 있습니다. 계속하시겠습니까?';
  ...
  String updateAvailableBody(String ver, String build) {
    return '새로운 버전의 FT-music🌸가 출시되었습니다!\n\n버전: $ver+$build';
  }
  ...
  @override
  String get pluginBootstrapTitle => 'FT-music 설정 중';
