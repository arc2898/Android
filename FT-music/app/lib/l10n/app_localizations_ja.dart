...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get onboardingTitle => 'FT-musicへようこそ';
  ...
  @override
  String get updateCheckSubtitle => 'FT-music の新しいバージョンがあるか確認します。';
  ...
  @override
  String get updateUpToDate => 'FT-music🌸 は最新の状態です！';
  ...
  @override
  String get updateNewVersionAvailable => 'FT-music🌸 の新しいバージョンが利用可能です！';
  ...
  @override
  String get aboutTipQuote => 'FT-music を気に入っていただけましたか？応援が活動の励みになります。 🌸';
  ...
  @override
  String get songInfoSearchTitle => 'FT-music でこの曲を検索';

  @override
  String get songInfoSearchArtist => 'FT-music でこのアーティストを検索';

  @override
  String get songInfoSearchAlbum => 'FT-music でこのアルバムを検索';
  ...
  @override
  String get importBloomeeFiles => 'FT-music ファイルをインポート';
  ...
  @override
  String get importNoteMessage => 'FT-music で作成されたファイルのみが対象です。続行しますか？';
  ...
  String updateAvailableBody(String ver, String build) {
    return 'FT-music🌸 の新しいバージョンが利用可能です！\n\nバージョン: $ver+$build';
  }
  ...
  @override
  String get pluginBootstrapTitle => 'FT-music をセットアップ中';
