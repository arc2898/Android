...
import 'package:ft_music/core/models/exported.dart' as models;
import 'package:ft_music/services/db/global_db.dart';
import 'package:ft_music/services/db/dao/cache_dao.dart';
import 'package:ft_music/services/db/dao/history_dao.dart';
...
import 'package:ft_music/services/db/dao/search_history_dao.dart';
  ...
  static Future<Isar> openDB() async {
    if (Isar.instanceNames.isEmpty) {
      ...
      if (!await dbFile.exists() &&
        ...
        final tempDb =
            Isar.openSync(_schemas, directory: appDocDir, name: 'dbv3');
    ...
    try {
      ...
      final backupPayload = <String, dynamic>{
        '_meta': {
          ...
          'generatedBy': 'FT-music DBProvider',
